...
module.exports = {
  input: {
    path: "./arches_he_sysref_funcs/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_he_sysref_funcs/locale", // output path of all created files
