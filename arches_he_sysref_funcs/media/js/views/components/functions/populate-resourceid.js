define(['knockout',
        ...
        'viewmodels/function',
        'bindings/chosen',
        'templates/views/components/functions/populate-resourceid.htm'],
function (ko, koMapping, ListView, FunctionViewModel, chosen, populateResourceIdTemplate) {
        ...
        return ko.components.register('views/components/functions/populate-resourceid', {
        viewModel: viewModel,
        template: populateResourceIdTemplate,
    });
});