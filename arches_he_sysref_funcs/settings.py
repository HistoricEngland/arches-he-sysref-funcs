"""
Django settings for arches_he_sysref_funcs project.
"""
...
APP_VERSION = semantic_version.Version(major=1, minor=0, patch=2)
...
ETL_MODULE_LOCATIONS.append("arches_he_sysref_funcs.etl_modules")
SEARCH_COMPONENT_LOCATIONS.append("arches_he_sysref_funcs.search_components")
...
SECRET_KEY = "django-insecure-mccsa^u_7*99&5whg3obu&#xzi#d_fsiau2p#h&@1l!+uu5!g*"
...
# [{
#     'module': 'arches_he_sysref_funcs.search_indexes.sample_index.SampleIndex',
...
INSTALLED_APPS = (
    ...
    # "silk",
    "arches_he_sysref_funcs",  # Ensure the project is listed before any other arches applications
)
...
WSGI_APPLICATION = "arches_he_sysref_funcs.wsgi.application"
...
SESSION_COOKIE_NAME = "arches_he_sysref_funcs"
...
# ES_MAPPING_MODIFIER_CLASSES = ["arches_he_sysref_funcs.search.es_mapping_modifier.EsMappingModifier"]
